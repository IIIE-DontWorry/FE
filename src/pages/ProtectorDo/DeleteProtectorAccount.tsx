// src/pages/ProtectorDo/DeleteProtectorAccount.tsx
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              const response = await ApiService.post<ApiResponse>('/guardian/myPage/delete/1');
    ...
    <Container>
      ...
      <ContentContainer>
        <WarningSection>
          ...
          <WarningText>• 간병인과의 연결이 모두 해제됩니다.</WarningText>
...
export default DeleteProtectorAccount;