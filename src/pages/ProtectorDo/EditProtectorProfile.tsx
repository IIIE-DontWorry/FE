...
const EditProtectorProfile = () => {
 ...
 const handleChange = (
  ...
  const handleSubmit = async () => {
    try {
      const response = await ApiService.patch('/guardian/myPage/update/1', formData.guardianInfo);
     ...
     <ScrollContainer>
       <Section>
         ...
         <InputGroup>
           ...
           <Input
             ...
             onChangeText={(text) => handleChange('guardianInfo', 'address', text)}
       ...
       <Section>
         ...
         <InputGroup>
           ...
           <Input
             ...
             onChangeText={(text) => handleChange('patientInfo', 'age', Number(text))}
         ...
         <InputGroup>
           ...
           <Input
             ...
             onChangeText={(text) => handleChange('patientInfo', 'diseaseName', text)}
         ...
         <InputGroup>
           ...
           <Input
             ...
             onChangeText={(text) => handleChange('patientInfo', 'hospitalName', text)}
       ...
       <Section>
          <Row>
            ...
            <SubmitButton onPress={handleMedicationSubmit} style={{ marginLeft: 'auto', padding: 8 }}>
          ...
          {medications.map((medication, index) => (
            <Row key={index}>
              ...
              />
              <IconButton
                onPress={() => index === medications.length - 1 
                  ? addMedication() 
                  : removeMedication(index)}
              >
                <IconText>{index === medications.length - 1 ? '+' : '-'}</IconText>
              </IconButton>
            </Row>
          ))}
        </Section>
        ...
        <Section>
          <Row>
            ...
            <SubmitButton onPress={handleSpecialRequestSubmit} style={{ marginLeft: 'auto', padding: 8 }}>
          ...
          {specialRequests.map((request, index) => (
            <Row key={index}>
              ...
              />
              <IconButton
                onPress={() => index === specialRequests.length - 1 
                  ? addSpecialRequest() 
                  : removeSpecialRequest(index)}
              >
                <IconText>{index === specialRequests.length - 1 ? '+' : '-'}</IconText>
              </IconButton>
            </Row>
          ))}
        </Section>
